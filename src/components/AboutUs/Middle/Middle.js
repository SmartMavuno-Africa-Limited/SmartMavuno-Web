...
import { faHouse, faHandHoldingDollar, faCartShopping } from '@fortawesome/free-solid-svg-icons';
        ...
        <div className="row">
          <div data-aos='fade-right' data-aos-offset="170" className="col-md-4">
            <div className={styles.box}>
              <FontAwesomeIcon icon={faHouse} size="3x" className={styles.icon} />
          ...
          <div data-aos='fade-up' className="col-md-4">
            <div className={styles.box}>
              <FontAwesomeIcon icon={faHandHoldingDollar} size="3x" className={styles.icon} />
          ...
          <div data-aos='fade-left' className="col-md-4">
            <div className={styles.box}>
              <FontAwesomeIcon icon={faCartShopping} size="3x" className={styles.icon} />
