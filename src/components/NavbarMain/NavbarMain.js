          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav style={{ marginLeft: "auto" }}>
              ...
              <Button
                ...
                onMouseEnter={(e) => {
                  e.target.style.backgroundColor = "black"; // Black hover
                  e.target.style.borderColor = "black"; // Black hover border
                }}
                onMouseLeave={(e) => {
                  e.target.style.backgroundColor = "#28a745"; // Reset to green
                  e.target.style.borderColor = "#28a745"; // Reset to green
                }}
              >
                GET STARTED
              </Button>
