                    ...
                    <div className={styles.infoSection}>
                        ...
                        <div className={styles.socialSection}>
                            ...
                            <div className={styles.socialIcons}>
                                <a href="https://www.facebook.com/profile.php?id=100089102720769&mibextid=ZbWKwL" className={styles.socialLink}><i className="fab fa-facebook-f"></i></a>
                                <a href="https://x.com/SmartMavuno" className={styles.socialLink}><i className="fab fa-twitter"></i></a>
                                <a href="https://www.instagram.com/smartmavuno?igsh=MTRhZHUzcXBseHlhaQ%3D%3D" className={styles.socialLink}><i className="fab fa-instagram"></i></a>
                                <a href="https://www.linkedin.com/company/smartmavuno" className={styles.socialLink}><i className="fab fa-linkedin-in"></i></a>
                            </div>
                        </div>
                    </div>
